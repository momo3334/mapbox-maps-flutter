...
enum class NavigationCameraStates(val raw: Int) {
  IDLE(0),
  ...
  companion object {
    fun ofRaw(raw: Int): NavigationCameraStates? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}
...
private open class MessagesPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      131.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          NavigationCameraStates.ofRaw(it.toInt())
        }
      }
    ...
    fun setUp(
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationManager.setRoute$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationManager.setRouteById$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationManager.cancelRoute$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationManager.getNavigationSessionState$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { _, reply ->
...
interface _NavigationInstanceManager {
  ...
  companion object {
    ...
    fun setUp(
      binaryMessenger: BinaryMessenger,
      api: _NavigationInstanceManager?,
      messageChannelSuffix: String = ""
    ) {
      val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationInstanceManager.setupNavigationManager$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationInstanceManager.tearDownNavigationManager$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
...
interface _NavigationCameraManager {
  ...
  fun getNavigationCameraState(): NavigationCameraStates
  fun followingPitchPropertyOverride(pitch: Double)
  fun followingBearingPropertyOverride(bearing: Double)
  fun overviewPitchPropertyOverride(pitch: Double)
  fun overviewBearingPropertyOverride(bearing: Double)
  fun overviewZoomPropertyOverride(zoom: Double)
  fun followingZoomPropertyOverride(zoom: Double)
  ...
  companion object {
    ...
    fun setUp(
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.requestNavigationCameraToOverview$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.requestNavigationCameraToFollowing$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.getNavigationCameraState$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              listOf(api.getNavigationCameraState())
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.followingPitchPropertyOverride$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> = try {
              api.followingPitchPropertyOverride(pitchArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.followingBearingPropertyOverride$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val bearingArg = args[0] as Double
            val wrapped: List<Any?> = try {
              api.followingBearingPropertyOverride(bearingArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.overviewPitchPropertyOverride$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pitchArg = args[0] as Double
            val wrapped: List<Any?> = try {
              api.overviewPitchPropertyOverride(pitchArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.overviewBearingPropertyOverride$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val bearingArg = args[0] as Double
            val wrapped: List<Any?> = try {
              api.overviewBearingPropertyOverride(bearingArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.overviewZoomPropertyOverride$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> = try {
              api.overviewZoomPropertyOverride(zoomArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.followingZoomPropertyOverride$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val zoomArg = args[0] as Double
            val wrapped: List<Any?> = try {
              api.followingZoomPropertyOverride(zoomArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.clearFollowingOverrides$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              api.clearFollowingOverrides()
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._NavigationCameraManager.clearOverviewOverrides$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              api.clearOverviewOverrides()
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
  ...
  companion object {
    ...
    fun setUp(
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._PlaceAutocompleteManager.suggestions$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._PlaceAutocompleteManager.select$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
...
interface _PlaceAutocompleteInstanceManager {
  ...
  companion object {
    ...
    fun setUp(
      binaryMessenger: BinaryMessenger,
      api: _PlaceAutocompleteInstanceManager?,
      messageChannelSuffix: String = ""
    ) {
      val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._PlaceAutocompleteInstanceManager.setupPlaceAutocompleteManager$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(
          binaryMessenger,
          "dev.flutter.pigeon.mapbox_maps_flutter._PlaceAutocompleteInstanceManager.tearDownPlaceAutocompleteManager$separatedMessageChannelSuffix",
          codec
        )
        if (api != null) {
          channel.setMessageHandler { message, reply ->
