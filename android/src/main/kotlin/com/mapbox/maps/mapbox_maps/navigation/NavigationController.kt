...
class NavigationController(
  ...
  private val navigationStatusObserver =
...
//    navigationCamera.requestNavigationCameraToOverview()
  ...
  private fun setupEventChannels() {
    ...
    EventChannel(
      messenger,
      "com.mapbox.maps.flutter/navigation#direction_route",
    ).setStreamHandler(
      object : EventChannel.StreamHandler {
        override fun onListen(arguments: Any?, sink: EventSink?) {
...
//    navigationCamera.requestNavigationCameraToFollowing()
  ...
  override fun setRouteById(routeId: String) {
    val newNavigationRoute = MapboxNavigationApp.current()?.getNavigationRoutes()?.first {
      it.id == routeId
    }
      ...
      MapboxNavigationApp.current()?.setNavigationRoutes(listOf(newNavigationRoute)) {
        if (it.isValue) {
          val currentNavigationSessionState =
            MapboxNavigationApp.current()!!.getNavigationSessionState()
          eventSinkNavigationState?.success(gson.toJson(currentNavigationSessionState.javaClass.simpleName))
        }
      }
    }
  }
  ...
  override fun getNavigationSessionState(): String {
    ...
    return getRealNavigationSessionState(
